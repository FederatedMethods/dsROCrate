...
[![Codecov test coverage](https://codecov.io/gh/DataSHIELD-5S/dsROCrate/graph/badge.svg)](https://app.codecov.io/gh/DataSHIELD-5S/dsROCrate)
<!-- badges: end -->
...
You can install the development version of dsROCrate from [GitHub](https://github.com/DataSHIELD-5S/dsROCrate/) with:
...
using the `dsROCrate::rocrate_report`:
...
```{r safe_people_crate_audit_v2, warning=FALSE}
...
unlink(safe_people_crate_v2_rmd, TRUE, TRUE)
